...
Colorist_Kirki::add_field( 'colorist', array(
	...
	'label'    => __( 'Exclude the Posts from Home Page. Post IDs, separated by commas', 'colorist' ),
	'section'  => 'latest_blog_section',
	'type'     => 'text',
	'active_callback' => array(
		array(
	...
	'output' => array(
		...
		array(
			'element'  => '.main-navigation a:hover,.main-navigation .current_page_item a, .main-navigation .current-menu-item a, .main-navigation .current-menu-parent > a, .main-navigation .current_page_parent > a,input[type="button"],input[type="reset"],input[type="submit"],.main-navigation ul ul li,.sub-menu .current_page_item > a,.sub-menu .current-menu-item > a,.sub-menu .current_page_ancestor > a,.site-content .navigation .nav-links a:hover,.site-content .more-link:hover, 
							...
							.site-footer .scroll-to-top:hover,.blog .flexslider .slides .flex-caption p a,.blog .flexslider .flex-control-paging li .flex-active,button.menu-toggle:hover',																				
		...
		array(
			'element'  => 'a,th a,button,.required,
							...
							.woocommerce-page table.cart a.remove,.star-rating,.blog .flexslider .slides .flex-caption h2',
			'property' => 'color',
		),
		array(
...
Colorist_Kirki::add_section( 'scroll_to_top', array(
	'title'          => __( 'Scroll to Top','colorist' ),
	'description'    => __( 'Scroll to Top Button', 'colorist'),
	'panel'          => 'header_panel', // Not typically needed.
) );
Colorist_Kirki::add_field( 'colorist', array(    
	'settings' => 'scroll_to_top_button',
	'label'    => __( 'Enable Scroll to Top', 'colorist' ),
...
Colorist_Kirki::add_section( 'header_image', array(
	'title'          => __( 'Header Background Image & Video','colorist' ),
	'description'    => __( 'Custom Header Image & Video options', 'colorist'),
	'panel'          => 'header_panel', // Not typically needed.  
) );
...
Colorist_Kirki::add_field( 'colorist', array(
	...
	'label'    => __( 'Blog Slider Posts category', 'colorist' ),
	'section'  => 'blog',
	'type'     => 'select',
	'choices' => Kirki_Helper::get_terms( 'category' ),
	'active_callback' => array(
